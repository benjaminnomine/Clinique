...
namespace ConsoleApp2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //IDataService<Categorie> dataServiceCategorie = new GenericDataService<Categorie>(new CliniqueDbContextFactory("Data Source=(localdb)\\MSSQLlocalDB;Integrated Security=True;Database=Clinique;"));
            ...
            //IDataService<Medicament> dataServiceMedicament = new GenericDataService<Medicament>(new CliniqueDbContextFactory("Data Source=(localdb)\\MSSQLlocalDB;Integrated Security=True;Database=Clinique;"));
            ...
            //IDataService<Docteur> dataServiceDocteur = new GenericDataService<Docteur>(new CliniqueDbContextFactory("Data Source=(localdb)\\MSSQLlocalDB;Integrated Security=True;Database=Clinique;"));
